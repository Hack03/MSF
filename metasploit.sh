...
echo -e "${rojo}╭═════════════════════════╮"${blanco}
sleep 0.1
echo -e "${rojo}║    ᴇʟ ᴄᴏɴᴏᴄɪᴍɪᴇɴᴛᴏ ᴇꜱ ʟɪʙʀᴇ        ║"${blanco}
sleep 0.1
echo -e "${rojo}╰═════════════════════════╯"${blanco}
sleep 0.1
           echo -e "${rojo}╭══════════╮"${blanco}
sleep 0.1
           echo -e "${rojo}║  ʙʏ Hack-2.0 ║"${blanco}
sleep 0.1
           echo -e "${rojo}║  #OpCuba    ║"${blanco}
sleep 0.1
           echo -e "${rojo}╰══════════╯"${blanco}
sleep 0.5                
echo -e ""
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${verde} Instalando paquetes requeridos...${blanco}"
sleep 0.5
...
echo -e ""
sleep 1
echo -e "${rojo}[${verde}*${rojo}]${verde} Instalando Metasploit-Framework...${blanco}"
sleep 0.5
echo -e ""
#!/data/data/com.termux/files/usr/bin/bash
sleep 1
...
sleep 0.5
echo -e ""
echo -e "${rojo}[${verde}*${rojo}]${verde} Iniciando instalación...${blanco}"
...
sleep 1
echo -e ""
echo -e "${rojo}[${verde}*${rojo}]${verde} Dependencias wget, curl, zip tar, etc...${blanco}"
...
if [[ $replyme == 'y' ]];then
echo -e ""
echo -e "${rojo}[${verde}√]${rojo}]${verde} Listo! Metasploit V6.1.42 se a instalado exitosamente...${blanco}"
sleep 2
